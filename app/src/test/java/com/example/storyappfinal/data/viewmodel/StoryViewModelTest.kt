...
class StoryViewModelTest {
    ...
    fun uploadNewStory() {
        ...
        Mockito.`when`(mockApiService.doUploadImage(any(dummyToken::class.java) ,
            any(fakeImageMultipart::class.java), any(requestDescription::class.java))).thenReturn(mockCallUpload)
        storyViewModel.uploadNewStory(context,dummyToken, mockImageFile, dummyDescription, mockApiService)
        Mockito.verify(mockApiService).doUploadImage(any(dummyToken::class.java) ,
            any(fakeImageMultipart::class.java), any(requestDescription::class.java))
    }
